...
class EventsHorizontalRecyclerViewAdapter(private val mList: List<EventItemViewModel>, private val onItemClicked: (position: Int) -> Unit) : RecyclerView.Adapter<EventsHorizontalRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(_parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.card_event_horizontal_view, parent, false)
